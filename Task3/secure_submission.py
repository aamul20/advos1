...
# Dictionaries are the most efficient way to track 'live' session state 
lockout_strikes = {}     
access_timestamps = {}   
...
def upload_assignment():
    #Requirement: File Validation & Duplicate Detection.
    ...
    print(f"Success! '{fname}' is now in the vault.")
